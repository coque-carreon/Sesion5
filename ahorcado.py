# Juego de ahorcado donde se debe adivinar un nombre de ciudad en México, cuenta con 6 oportunidades de error, utiliza solo letras minúsculas y sin acentos

#Se importa la librearía random
import random
